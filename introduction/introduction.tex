...
Therefore, these could not be observed in a study looking as presumably healthy, or at least viable, offspring and would giving the impression of a recombination rate increase.
...
%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%
% \subsection{Conservation between species} combine
%%%%%%%%%%%%%%%%%%%%
...
The canid family provides an interesting look at recombination, since evidence exists that multiple truncating mutations occurred in canine PRDM9, rendering the gene inactive.
