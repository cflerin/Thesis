...
This model has a number of properties that fit into generally accepted properties of recombianation.
...
Due to sex-differences in recombination rate, any comparison between males and females must be done using the genetic position (in cM) of each crossover, which takes into account differences the genetic map length.
