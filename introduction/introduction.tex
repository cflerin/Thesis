...
Tracking the transmission of alleles from one generation to the next within known pedigrees provided the first data on recombination in early linkage studies, and pedigree analyses that are still in use today.
...
\section{Current maps of recombination.}
...
\hline Gene / region & Chr. & Association & Female rate & Male rate & Study & Replication \\ \hline
    ...
    \hline \end{tabular}
    \captionTitle{\textbf{Gene regions associated with recombination.}}{
...
The most direct association of recombination with disease is the association with aneuploidy\cite{Hassold2001}.
