...
Recombination is an essential process to the generation of gametes and shuffles genetic variation within the genome, generating new combination of alleles that can be subject to natural selection.
For a number of decades, recombination has been known to vary widely in its frequency and placement within the genome as well as between individuals, sexes and populations, and different species.
Most research to date has focused on crossover, the reciprocal exchange of information between homologous chromosomes.
These studies has used pedigree analysis and studies of linkage within the genome to discover crossover properties on a genome wide basis.


An alternate outcome of recombination is non-crossover, also known as gene conversion, the one-way transfer of small amounts of genetic material that occurs during the repair of double strand breaks in meiosis.
Gene conversion events are quite small (typically under 1000 base pairs), and are thus difficult to detect with current methods.
