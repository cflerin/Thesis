...
Recombination has been studied by a wide variety of approaches, including molecular methods such as sperm typing, as well and inferential methods, such as linkage disequilibrium modeling and pedigree analysis.
...
It has also been suggested that recombination could change with age.
...
I find that in older mothers there is a steep increase in crossovers escaping regulation by interference, and appear closely spaced, pointing to a possible deregulation of recombination that increases with age in females.

Additionally, I analyze crossovers in an inbred domestic dog pedigree, consisting of 408 meioses.
Dogs are unique in that PRDM9 in this species has undergone truncating mutations, rendering it inactive, and raising question as to how crossovers are placed without this regulatory mechanism.
...
Simulation results show that the model can plausibly used to detect gene conversion, however the complexity is high, with a large number of states at each site.
